...
db.Walker.hasOne(db.Disponibilidade,{foreignKey:'id'});
db.Disponibilidade.belongsTo(db.Walker,{foreignKey:'id'});
db.Cliente.hasOne(db.Pedido,{foreignKey:'id_usuario'});
db.Pedido.belongsTo(db.Cliente,{foreignKey:'id_usuario'});
db.Cliente.hasOne(db.FormaPagamento,{foreignKey:'id_usuario'});
db.FormaPagamento.belongsTo(db.Cliente,{foreignKey:'id_usuario'});
